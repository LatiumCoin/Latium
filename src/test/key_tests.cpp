...
static const CBitcoinAddress addr1 ("Af2iUrKqQEDdrMWDsDYuU68WFLG9QXSB5F");
static const CBitcoinAddress addr2 ("AVrqiivsgkjhobWsjoMfjMu9Ws9eaWfJ7o");
static const CBitcoinAddress addr1C("AdaBWJjWHXqUUAVtsB7PSTtQL8LvTwkyA9");
static const CBitcoinAddress addr2C("ATCbfnpyLMBfoFNWu4Z3REEn9yNqsN9n4Y");


static const string strAddressBad("AYG1z6uVhSE7khGZJkKWC29LEnngCs9oJP");
