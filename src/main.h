...
// Max money can only be as high as 2^63 - 1 which is 9,223,372,036,854.775807 coins. More money can be in circulation, this is the maximum amount of money that can be used in an output.
static const int64 MAX_MONEY = INT64_MAX;
static const int64 PREMINE = 105000000000 * COIN; // 105 billion coins
static const int CUTOFF_POW_BLOCK = 5000; // We only allow PoW for premine and premine maturity. Could have hardcoded in the premine and removed all PoW references, but this is the simplest/safest solution.
...
static const uint256 hashGenesisBlockOfficial("0x8aec47f47f77b5c3ca8c8e9e94a2cba4a51f78e578879d8cc9d0f7f958d7ee22");
static const uint256 hashGenesisBlockTestNet ("0x8aec47f47f77b5c3ca8c8e9e94a2cba4a51f78e578879d8cc9d0f7f958d7ee22");
...
public:
    ...
    bool ReadFromDisk(unsigned int nFile, unsigned int nBlockPos, bool fReadTransactions=true)
    {
        ...
        // Check the header
        if (fReadTransactions && IsProofOfWork() && hashPrevBlock != 0 && !CheckProofOfWork(GetHash(), nBits))
