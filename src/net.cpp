...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Latium " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char * strDNSSeed[][2] = {
    {"latium.cc", "seed1.latium.cc"},
    {"latium.cc", "seed2.latium.cc"},
    {"latium.cc", "seed3.latium.cc"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Latium is probably already running."), addrBind.ToString().c_str());
        else
